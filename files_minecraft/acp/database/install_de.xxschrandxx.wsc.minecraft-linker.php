...
return [
    // minecraft1_user_minecraft
    DatabaseTable::create('minecraft1_user_minecraft')
        ->columns([
    ...
    // minecraft1_user_to_user_minecraft
    DatabaseTable::create('minecraft1_user_to_user_minecraft')
        ->columns([
        ...
        ->foreignKeys([
            ...
            DatabaseTableForeignKey::create()
                ...
                ->referencedTable('minecraft1_user_minecraft')
        ])
];
