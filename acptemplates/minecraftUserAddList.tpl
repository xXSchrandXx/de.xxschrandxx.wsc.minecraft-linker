...
<header class="contentHeader">
	...
	<nav class="contentHeaderNavigation" role="presentation">
		<ul>
			<li><a href="{link controller='MinecraftUserAddText' id=$userID}{/link}" class="button"><span class="icon icon16 fa-exchange"></span> <span>{lang}wcf.page.minecraftUserAddACP.change{/lang}</span></a></li>
